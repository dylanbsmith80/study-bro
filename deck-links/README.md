# Study Bro Deck Links

This folder is the private GitHub registry of shareable Study Bro deck URLs. Each deck has a matching Markdown link record.

| Deck | Cards | Share link |
| --- | ---: | --- |
...
New deck workflows should create a matching `deck-links/FILENAME.md` record and add it to this table.
